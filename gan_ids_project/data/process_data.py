...
def load_data(base_data_dir, dataset):
    train_path = os.path.join(base_data_dir, 'raw_data', dataset, 'Splits', f'{dataset}_training-set.csv')
    test_path = os.path.join(base_data_dir, 'raw_data', dataset, 'Splits', f'{dataset}_testing-set.csv')
...
if __name__ == "__main__":
    ...
    datasets = ['NF-ToN-IoT-v1', 'UNSW-NB15']
